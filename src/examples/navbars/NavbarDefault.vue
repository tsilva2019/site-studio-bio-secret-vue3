  ...
  <nav class="navbar navbar-expand-lg top-0" :class="{
    ...
    <div :class="props.transparent || props.light || props.dark
      ...
      <RouterLink class="navbar-brand d-none d-md-block" :class="[
        ...
        data-placement="bottom"><img class="mx-2" src="../../assets/img/logo-bio-secret.png" width="55"
          height="40" />Studio Bio Secret
      </RouterLink>
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                      ...
                      <div class="d-flex">
                        <div class="w-100 d-flex align-items-center justify-content-between">
                          <div>
                            ...
                            <span class="text-sm">Veja todos</span>
                          </div>
                ...
                <ul class="list-group">
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                      ...
                      <span class="text-sm">Todos os produtos feitos para o seu rosto</span>
                    </a>
                  </li>
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                      ...
                      <span class="text-sm">Melhores seleções para seu cabelo</span>
                    </a>
                  </li>
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                      ...
                      <span class="text-sm">Produtos com qualidade comprovada</span>
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <li class="nav-item mx-1 my-1">
            <a :href="action.route" class="btn bg-gradient-primary btn-sm mb-0"
              onclick="smoothToPricing('pricing-soft-ui')">Cadastre-se</a>
          </li>
          <li class="nav-item mx-1 my-1">
