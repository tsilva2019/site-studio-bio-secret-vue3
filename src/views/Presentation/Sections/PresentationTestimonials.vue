...
<template>
  <section class="py-7">
    <div class="container">
      ...
      <div class="row mt-6">
        <DefaultReviewCard name="Nick Willever" date="1 day ago" review='"This is an excellent product, the documentation is excellent and
          helped me get things done more efficiently."' :rating="5.0" />
        <DefaultReviewCard class="ms-md-auto" color="bg-gradient-primary" name="Shailesh Kushwaha" date="1 week ago"
          review='"I found solution to all my design needs from Creative Tim. I
                  use them as a freelancer in my hobby projects for fun! And its
                  really affordable, very humble guys !!!"' :rating="5.0" />

        <DefaultReviewCard name="Samuel Kamuli" date="3 weeks ago" review='"Great product. Helped me cut the time to set up a site. I
